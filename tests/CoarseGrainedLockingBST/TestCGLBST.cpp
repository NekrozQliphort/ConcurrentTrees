...
TEST_CASE("CGL Insertion sequential check") {
...
TEST_CASE("CGL Deletion sequential check") {
...
TEST_CASE("CGL Insertion - Insertion Race") {
...
TEST_CASE("CGLBST Insertion - Deletion Race") {
